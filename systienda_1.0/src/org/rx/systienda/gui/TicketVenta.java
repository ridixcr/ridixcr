...
public class TicketVenta extends javax.swing.JInternalFrame implements Printable{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(TicketVenta.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        return imprimir(graphics, pageFormat, pageIndex,this.getRootPane());
    }
