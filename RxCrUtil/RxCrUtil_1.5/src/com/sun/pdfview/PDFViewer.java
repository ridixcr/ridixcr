...
public final class PDFViewer extends JFrame
     ...
     */
    public PDFViewer(boolean useThumbs) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        super(TITLE);        
...
//        System.out.println("Going to page " + pagenum);
    ...
    public static void testPDFViewer(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    public static void testPDFViewer() {        
        try {        
            ...
            @Override
                public void run() {
                        try {
                            ...
                            Logger.getLogger(JCalendarDemo.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (InstantiationException ex) {
                            Logger.getLogger(JCalendarDemo.class.getName()).log(Level.SEVERE, null, ex);
                        } catch (IllegalAccessException ex) {
                            Logger.getLogger(JCalendarDemo.class.getName()).log(Level.SEVERE, null, ex);
