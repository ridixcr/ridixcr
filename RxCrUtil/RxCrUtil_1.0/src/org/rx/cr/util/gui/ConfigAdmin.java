...
public class ConfigAdmin extends javax.swing.JDialog {
      ...
      if (conf.loadConf()) {
        ...
        if (conn!=null) {
          try {
                ...
                pst.execute("select * from "+getUserTable());            
                conn.close();
                pst.close();
                return true;
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/rx/systienda/resource/advancedsettings_min.png"))); // NOI18N
