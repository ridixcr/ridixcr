...
public class JCalendarDemo extends JApplet implements PropertyChangeListener {
	 ...
	 */	
        public static class FrameTest extends JFrame{
            public FrameTest() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException{
		...
		pack();
                setSize((int)getPreferredSize().getWidth()+40,(int)getPreferredSize().getHeight() + 250);		
        ...
        public static void testJCalendar() {
            java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
                public void run() {
                        try {
                            new JCalendarDemo.FrameTest().setVisible(true);
