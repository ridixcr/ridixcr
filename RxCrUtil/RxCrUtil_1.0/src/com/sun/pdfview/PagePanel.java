...
public class PagePanel extends JPanel implements ImageObserver, MouseListener, MouseMotionListener {
    ...
    /* Tamanio de Pagina de PDF */
    Dimension pageSize=null;
    
    /* Tamanio PAnel Contenedor*/
    Dimension sz =null;
    ...
    public synchronized void showPage(PDFPage page) {
        ...
        if (page == null) {
            ...
            pageSize = page.getUnstretchedSize(sz.width, sz.height,useClip);
            
            // get the new image
            currentImage = page.getImage(pageSize.width, pageSize.height,useClip, this);
            srcImage=page.getImage(pageSize.width, pageSize.height,useClip, this);
    ...
    //	g.drawRect(r.x, r.y, r.width-1, r.height-1);
        ...
        /*
         if (currentImage!=null) {
            g.drawLine(offx,0,offx,getHeight());
            g.drawLine(offx+currentImage.getWidth(null),0,offx+currentImage.getWidth(null),getHeight());
        }*/
...
//    }
    ...
    public void testRender(){
     int widthPage  = (int)currentPage.getBBox().getWidth();
     int heightPage = (int)currentPage.getBBox().getHeight();

    if(currentPage.getAspectRatio()<1){
        widthPage  =  (int)(widthPage / currentPage.getAspectRatio() );
        heightPage =  (int)(heightPage / currentPage.getAspectRatio() );
    }

    // get the width and height for the doc at the default zoom
    Rectangle rect = new Rectangle(offx,offy, (int) widthPage, (int) heightPage);
    // generate the image
    Image img = currentPage.getImage(rect.width, rect.height, // width & height
            rect, // clip rect
    ...
    //Rectangle rect = new Rectangle(0, 0, (int) widthPage, (int) heightPage);
      ...
      setClip(new Rectangle2D.Double(0,0,(int) widthPage,(int) heightPage));
       // System.out.println(widthPage+","+heightPage);
    }
    ...
    //Rectangle rect = new Rectangle(0, 0, (int) widthPage, (int) heightPage);
     ...
     // setClip(new Rectangle2D.Double(0,0,(int) widthPage,(int) heightPage));
        //System.out.println(currentPage.getBBox().getWidth()+","+currentPage.getBBox().getHeight()+":"+currentPage.getAspectRatio());
        int widthPage  = (int)currentPage.getBBox().getWidth();
     int heightPage = (int)currentPage.getBBox().getHeight();
    ...
    public void mouseDragged(MouseEvent evt) {
        ...
        }else{//mover en pantalla por hoja
