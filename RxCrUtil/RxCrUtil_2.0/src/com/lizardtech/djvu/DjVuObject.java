  ...
  implements DjVuInterface
{
  ...
  static
  {
    ...
    try{
      xgetMethod = Class.forName("java.lang.ref.Reference").getMethod("get", null);
      final Class[] params = {Object.class};
      xnewWeakReference=xnewSoftReference = Class.forName("java.lang.ref.SoftReference").getConstructor(params);
      xnewWeakReference = Class.forName("java.lang.ref.WeakReference").getConstructor(params);
