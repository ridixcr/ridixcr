...
public abstract class JDialogUC extends JDialog implements GenericFunctionUC{  
        ...
        b_buscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(JDialogUC.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
                ...
                try {
                    if(_isDatosValidosBE()){
                        ...
                        if(rsp>=0){            
                            ...
                            JOptionPane.showMessageDialog(JDialogUC.this,"Operacion exitosa.", "Atencion", JOptionPane.INFORMATION_MESSAGE);
                        }else{
                            JOptionPane.showMessageDialog(JDialogUC.this,"Error operacion fallida.", "Error", JOptionPane.ERROR_MESSAGE);
                        }          
                    }            
                } catch (Exception ex) {
                    Logger.getLogger(JDialogUC.class.getName()).log(Level.SEVERE, null,ex);
