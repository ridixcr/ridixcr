...
//            });
        ...
        public void paint(Graphics g) {
            ...
            big.setColor(GREEN);
            big.drawString(String.valueOf((int) totalMemory/1024) + "K Disponible",  4.0f, (float) ascent+0.5f);
        ...
        public void run() {
            ...
            while (thread == me && isShowing()) {
                ...
                if (MonitorMemoria.dateStampCB.isSelected()) {
    ...
    public static void main(String s[]) {
        final MonitorMemoria demo = new MonitorMemoria();
