...
public class VisorPDF extends JFrame
    ...
    Action printAction = new AbstractAction("Print...",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/print.gif"))) {
    ...
    ZoomAction zoomInAction = new ZoomAction("Zoom in",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/zoomin.gif")),2.0);
    ZoomAction zoomOutAction = new ZoomAction("Zoom out",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/zoomout.gif")),0.5);
    Action zoomToolAction = new AbstractAction("",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/zoom.gif"))) {
        @Override
        public void actionPerformed(ActionEvent evt) {
            doZoomTool();
        }
    };
    Action fitInWindowAction = new AbstractAction("Fit in window",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/fit.gif"))) {
        @Override
        public void actionPerformed(ActionEvent evt) {
            doFitInWindow();
        }
    ...
    Action fullScreenAction = new AbstractAction("Full screen",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/fullscrn.gif"))) {
    ...
    Action nextAction = new AbstractAction("Next",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/next.gif"))) {
    ...
    Action firstAction = new AbstractAction("First",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/first.gif"))) {
    ...
    Action lastAction = new AbstractAction("Last",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/last.gif"))) {
    ...
    Action prevAction = new AbstractAction("Prev",new javax.swing.ImageIcon(getClass().getResource("/com/sun/pdfview/resource/prev.gif"))) {
     ...
     */
    public VisorPDF(boolean useThumbs) {
        super(TITLE);
    ...
    protected void init() {
        ...
        jb.setText("");
        jb.setToolTipText("Ir a la primera pagina");
        toolbar.add(jb);
        ...
        jb.setText("");
        jb.setToolTipText("Ir a la ultima pagina");
        toolbar.add(jb);
        ...
        fullScreenButton.setToolTipText("Cambiar a modo pantalla completa");
        ...
        jtb.setText("");
        jtb.setToolTipText("Habilitar herramienta de zoom");
        bg.add(jtb);
        toolbar.add(jtb);
        ...
        file.addSeparator();
        file.add(quitAction);
        //file.add(zoomInAction);
        //file.add(zoomOutAction);
        mb.add(file);
...
//        System.out.println("Going to page " + pagenum);
    ...
    private void openPDFByteBuffer(ByteBuffer buf, String path, String name) {
        ...
        setTitle(TITLE+" : "+curFile.getNumPages()+" Paginas");
    }
    ...
    class PrintThread extends Thread {
        ...
        public void run() {
            try {
                ...
                JOptionPane.showMessageDialog(VisorPDF.this,
