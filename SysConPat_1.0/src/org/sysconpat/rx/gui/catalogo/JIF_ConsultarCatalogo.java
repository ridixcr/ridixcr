...
public final class JIF_ConsultarCatalogo extends javax.swing.JInternalFrame {
    ...
    public void cargarCombos() {
        try {            
            ...
            Logger.getLogger(JIF_ConsultarCatalogo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void generarReporte() {      
        ...
        switch(jTabbedPane1.getSelectedIndex()){
            ...
            case 1:                    
                report = new ReportGeneric(root.getConfig());
                report.setReportParent("/org/sysconpat/rx/report/");
                reportFrame = report.mkReportToInternalFrame("catalogo_bienes_cod_den", 
                                                             new String[]{"p_referencia"}, 
                                                             new Object[]{jTextField1.getText().trim()}, 
                                                             "Catalogo de Bienes por COD. PATRIMONIAL / DENOMINACION");
                reportFrame.setFrameIcon(getFrameIcon());
                root.insertarInternalFrames(reportFrame);
                resetControl();
                break;
