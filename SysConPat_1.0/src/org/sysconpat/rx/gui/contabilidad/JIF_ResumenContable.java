...
public class JIF_ResumenContable extends javax.swing.JInternalFrame {
    private JF_Principal root;
    private BLBienPatrimonial bl = null;
    public JIF_ResumenContable(JF_Principal root) {
        initComponents();
        this.root=root;
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {            
            ...
            Logger.getLogger(JIF_ResumenContable.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void generarReporte() {           
        ...
        JInternalFrame reportFrame = report.mkReportToInternalFrame("resumen_contableFinal", new String[]{"p_fecha_calculo"}, new Object[]{jDateChooser1.getDate()}, "Resumen Contable");
